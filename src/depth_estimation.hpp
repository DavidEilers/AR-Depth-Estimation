...
namespace arDepthEstimation{
    ...
    class DepthEstimator{
        ...
        DepthEstimator(int input_width, int input_height, bool is_single_texture, float gamma=1.0, bool is_upside_down=false): m_input_width{input_width}, m_input_height{input_height}, m_output_width{input_width/4},m_output_height{input_height/4}{
            create_framebuffer();
            create_shader();
            create_vao();
            logger_info << "Depth Estimatior" <<m_input_width/2 << m_input_height/2 << m_output_width << m_output_height;
            m_downscaler = new Downscaler{m_input_width/2,m_input_height/2,m_output_width,m_output_height,is_single_texture, gamma, is_upside_down};
        }
