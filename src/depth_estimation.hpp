...
class DepthEstimator
{
    ...
    std::array<Downscaler*,3> m_downscalers{};
    //Downscaler *m_downscaler;
    FrameTimeProbe m_ftp_downscale{"Downscaling Image"};
  ...
  public:
    ...
    FrameTimeProbe& get_ftp_downscale(){
        return m_ftp_downscale;
    }
