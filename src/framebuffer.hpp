...
class Framebuffer
{
  ...
  public:
    Framebuffer(size_t width_, size_t height_) : m_width{width_}, m_height{height_}
    {
        ...
        glTexImage2DMultisample(GL_TEXTURE_2D_MULTISAMPLE, 4, GL_RGBA8, m_width, m_height,
                                true); // 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr);
        ...
        if (status != GL_FRAMEBUFFER_COMPLETE)
        {
            ...
            case GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS:
                error_str += "INCOMPLETE_LAYER_TARGETS";
                break;
            default:
                error_str += "unknown error_str";
                break;
            }
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, m_framebuffer_resolve_texture_id,
                               0);
